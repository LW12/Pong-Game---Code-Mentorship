...
p1_comments_list = ["You're killing it, ", "Nice Shot, ", "Better luck next time, ", "Good one, ","That one was killer, ", "Way to go, "]

p2_comments_list = ["You're on a roll, ","Your opponent better watch their back, ", "You're killing it once again, ", "Is it talent or skill? You've got both, ", "You're destroying them, ", "Incredible, "]
...
def game():
    ...
    while p1_score < 3 and p2_score < 3: 
        ...
        draw_paddle_1()
        draw_paddle_2()
        while ball.xcor() > -360 and ball.xcor() < 380: 
            # Ball Movement
